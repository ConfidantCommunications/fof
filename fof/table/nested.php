...
use FOF30\Utils\ArrayUtils\ArrayUtils;
...
class Nested extends Table
{
	 ...
	 *
	 * The object is reset after the copy.
	 *
	...
	/**
	 * Creates and returns a duplicate copy of the node
	 *
	 * @return static
	 */
